            ...
            <View style={{width:'90%',alignSelf:'center',marginTop:30}}>
               <View style={[{flexDirection:'row'},styles.textbox]}>
                ...
                <TouchableOpacity style={styles.signUpBtn}>
                  <Text style={{color:'black',alignSelf:'flex-end',paddingRight:20,fontSize:18,fontWeight:'700',marginTop:5}}>Forgot Password ?</Text>
                </TouchableOpacity>
                ...
                <Icon style={{justifyContent:'center',alignSelf:'center',paddingRight:10}} name="google-plus" size={20} color="white" />
                 ...
                 <TouchableOpacity onPress={()=>{navigation.navigate('SignUp')}} style={styles.signUpBtn}>
                  <Text style={{color:'black',alignSelf:'center',fontSize:18,fontWeight:'700',marginTop:15}}>New User? Create Account</Text>
                </TouchableOpacity>
